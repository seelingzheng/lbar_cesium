...
function test_3() {
    ...
    loader.load('./models/spaceman/scene.gltf', function(gltf) {
...
function test_4() {
    ...
    loader.load('./models/DNA/scene.gltf', function(gltf) {
...
function test_5() {
    ...
    // 15.9M race  
    loader.load('./models/race/scene.gltf', function(gltf) {
...
function test_6() {
    ...
    // 21M crab
    loader.load('./models/crab/scene.gltf', function(gltf) {
